...
// _row -> row index of desired point
    public static Grid_Point getPoint(int _col, int _row, Point_Grid _pg) {
    ...
    public static Grid_Point getPointSafe(int _col, int _row, Point_Grid _pg) {
...
// _index -> column to grab
    public static ArrayList<Grid_Point> getColumnByIndex(Point_Grid _pg, int _index) {

        return _pg.points.get(_index);
...
// _pg -> POINT_GRID to fetch from (POINT_GRID)
// _index -> row to grab
    public static ArrayList<Grid_Point> getRowByIndex(Point_Grid _pg, int _index) {
...
// _pg -> POINT_GRID to fetch from
    public static Grid_Point getOppositePoint(int _col, int _row, Point_Grid _pg){
...
// _row -> row index of source point
// _pg -> POINT_GRID to fetch from
    public static Grid_Point getOppositePointVert(int _col, int _row, Point_Grid _pg) {
...
// _row -> row index of source point
// _pg -> POINT_GRID to fetch from
    public static Grid_Point getOppositePointHor(int _col, int _row, Point_Grid _pg) {
...
// _pg -> POINT_GRID to sample from
    public static ArrayList<Grid_Point> getLine(int _col0, int _row0, int _col1, int _row1, Point_Grid _pg) {
...
// _col1, _row1 -> end point of line (by col and row index of POINT_GRID)
// _pg -> POINT_GRID to sample from
    public static ArrayList<Grid_Point> getLine_No_Op(int _col0, int _row0, int _col1, int _row1, Point_Grid _pg) {
...
// _pg -> POINT_GRID to sample from
    public static ArrayList<Grid_Point> getCircle(int _col, int _row, int _rad, Point_Grid _pg) {
...
// _pg -> point grid to sample from
    public static ArrayList<Grid_Point> getPattern(int _col, int _row, List<Integer> _dlist, int _reps, boolean _overflow, Point_Grid _pg) {
        ...
        for (Grid_Point grid_point : temp_result) {
            result.add(grid_point);
        }
...
// _pg: Point_Grid to sample from
    public static ArrayList<Grid_Point> getRandom(double _low, double _high, Point_Grid _pg) {
        ...
        mod_grid = Applicators.applyRandom(false, mod_grid);
...
// _high: top cutoff for weight
// _pg: Point_Grid to sample from
    public static ArrayList<Grid_Point> getThreshold(double _low, double _high, Point_Grid _pg) {
